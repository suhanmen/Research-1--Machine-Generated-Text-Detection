...
# output_directory = r'C:\Users\SJK\Desktop\ToC-Work\1.research(1)\Task1\Crowling\extracted_files\sample_results\5.mktxt'
...
# for i in site_list:
#     file_path = os.path.join(output_directory, f'text_file_{244+point}.txt')  # 파일 경로 생성
#     site = i.split("\n")
#     txt_list = []
...
for i in site_list:
    ...
    save_results_to_txt(txt_list, file_path)
    time.sleep(2+random.random())
    point += 1
