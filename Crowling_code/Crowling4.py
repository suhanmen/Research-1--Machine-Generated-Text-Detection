...
def save_results_to_txt(txt_list, output_directory, point):
    output_file_path = os.path.join(output_directory, f'result_{244+point}.txt')
...
## 실행
directory_path = r'C:\Users\SJK\Desktop\ToC-Work\1.research(1)\Task1\Crowling\extracted_files\sample_results\total_data\5. 244~257\data'
output_directory = r'C:\Users\SJK\Desktop\ToC-Work\1.research(1)\Task1\Crowling\extracted_files\sample_results\total_data\5. 244~257\244'
