...
def save_results_to_txt(txt_list, output_directory, point, save = 0):
    output_file_path = os.path.join(output_directory, f'result_{point + 243, save}.txt')
...
## 실행
#directory_path = r'1.research(1)/Task1/Crowling/extracted_files/1.task_total_url'
#output_directory = r'1.research(1)/Task1/Crowling/extracted_files/2.results'

directory_path = r'1.research(1)/Task1/Crowling/extracted_files/sample_files'
output_directory = r'1.research(1)/Task1/Crowling/extracted_files/sample_results'
output_directory2 = r'1.research(1)/Task1/Crowling/extracted_files/save_point'
...
for i in site_list:
    ...
    for path in site:
        ...
        save += 1
        if save == 10000:
            save_results_to_txt(txt_list, output_directory2, point, save_point)
            save_point += 1
            save = 0
